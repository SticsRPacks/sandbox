...
[![AppVeyor build status](https://ci.appveyor.com/api/projects/status/github/packs4stics/sandbox?branch=master&svg=true)](https://ci.appveyor.com/project/packs4stics/sandbox) [![Travis build status](https://travis-ci.org/packs4stics/sandbox.svg?branch=master)](https://travis-ci.org/packs4stics/sandbox) [![Coverage status](https://codecov.io/gh/packs4stics/sandbox/branch/master/graph/badge.svg)](https://codecov.io/github/packs4stics/sandbox?branch=master) [![Project Status: Active – The project has reached a stable, usable state and is being actively developed.](https://www.repostatus.org/badges/latest/active.svg)](https://www.repostatus.org/#active) <!-- [![License: GPL v3](https://img.shields.io/badge/License-GPL%20v3-blue.svg)](https://www.gnu.org/licenses/gpl-3.0) -->
...
2.  Download and install [Github desktop](https://desktop.github.com/), an app that will help you use GIT.
...
You can add the badge to your README, such as: [![Coverage status](https://codecov.io/gh/packs4stics/sandbox/branch/master/graph/badge.svg)](https://codecov.io/github/packs4stics/sandbox?branch=master).
