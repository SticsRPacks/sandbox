...
To do so, you can create your own branch using Github desktop. Usually, we name a branch after the feature it is supposed to add. You can make a new branch for each independent feature you want to use. To create a new branch, simply follow the steps showed below:
